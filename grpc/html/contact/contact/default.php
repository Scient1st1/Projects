...
__JS__;
    ...
    <div class="col-md-6">
        <form action="<?php echo JRoute::_('index.php'); ?>" method="post" name="emailForm" id="emailForm" class="form-validate">
            <div class="contact_email<?php echo $this->escape($this->params->get('pageclass_sfx')); ?>">
                <div class="contact_form_left">
                    <div class="contact_form_row">
                        ...
                        <input type="text" name="name" id="contact_name" size="30" class="inputbox" value=""  placeholder="<?php echo JText::_('name'); ?>"/>
                    </div>
                    <div class="contact_form_row">
                        <label id="contact_emailmsg" for="contact_email">
                            <?php echo JText::_('Email address'); ?><span class="must_have">*</span>:
                        </label>
                        <input type="text" id="contact_email" name="email" size="30" value="" class="inputbox required validate-email" maxlength="100" placeholder="<?php echo JText::_('email'); ?>"/>
                    </div>
                    <div class="contact_form_row">
                    ...
                    <div class="contact_form_row"><!--telephone-->
                        ...
                        <input type="text" placeholder=" <?php echo JText::_('Telephone'); ?>" name="telephone" id="contact_telephone" size="30" class="inputbox" value="" />
                    </div>
                </div>
                ...
                <div class="clr"></div>
                  ...
                  <!--CAPTCHA -->
            <?php if ($this->params->get('show_captcha') == 1 OR $this->params->get('show_captcha') == 0): ?>
            <div class="item_form">
                <div class="item_label">
                    <div class="item_label_captcha_in">
                        <label id="captcha" for="regcaptcha" class="param_lbl">
                            <?= JText::_('CAPTCHA'); ?><span class="must_have">*</span>:
                        </label>
                    </div>
                </div>
                <div class="item_box">
            ...
            <?php elseif($this->params->get('show_captcha') == 2): ?>
    ...
    <div class="contact_infos  col-md-6">
        <div class="contact_infos_in different_contact">
        ...
        if ($this->contact->address && $this->params->get('show_address')) {
            ...
            <div class="contact_address">
                <div class="contact_text"><div class="text_contact"></div></div>
