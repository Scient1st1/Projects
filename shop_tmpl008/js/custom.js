...
//    mobile screen slidetoggles
    if (window.innerWidth < 501) {
        
        $('.filter-holder .module_title').click(function () {
            $('.filter-holder .module_body').slideToggle();
        });
        
        $('.classifier-holder .module_title').click(function () {
            $('.classifier-holder .module_body').slideToggle();
        });
        
        $('.first .module_title').click(function(){
            $('.first .module_body').slideToggle();
        });
        
        $('.second .module_title').click(function(){
            $('.second .module_body').slideToggle();
        });
    }
