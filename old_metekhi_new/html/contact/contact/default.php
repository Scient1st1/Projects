            ...
            <div class="top_contacts">
                ...
                <form action="<?php echo JRoute::_('index.php'); ?>" method="post" name="emailForm" id="emailForm" class="form-validate">
                    <div class="contact_email<?php echo $this->escape($this->params->get('pageclass_sfx')); ?>">
                        ...
                        <!-- <div class="contact_form_title"> PLEASE GET IN TOUCH </div>-->

                        <div class="contact_form_row ">
                            <label for="contact_name">
                                <?php echo JText::_('Enter your name'); ?><span class="must_have">*</span>:
                            </label>
                            <input type="text" name="name" id="contact_name" size="30" class="inputbox font-CenturyGothic" value="" placeholder="Name"/>
                        </div>
                        <div class="contact_form_row">
                            <label id="contact_emailmsg" for="contact_email">
                                <?php echo JText::_('Email address'); ?><span class="must_have">*</span>:
                            </label>
                            <input type="text" id="contact_email" name="email" size="30" value="" class="inputbox required validate-email font-CenturyGothic" maxlength="100" placeholder="Email" />
                        </div>
                        <div class="contact_form_row ">
                            <label for="contact_subject">
                                <?php echo JText::_('Message subject'); ?>:
                            </label>
                            <input type="text" name="subject" id="contact_subject" size="30" class="inputbox font-CenturyGothic" value="" placeholder="Subject"/>
                        </div> 
                        <div class="contact_form_row"><!--telephone-->
                            <label for="contact_telephone">
                                <?php echo JText::_('Telephone'); ?><span class="must_have">*</span>:
                            </label>
                            <input type="text" name="telephone" id="contact_telephone" size="30" class="inputbox font-CenturyGothic" value="" placeholder="Phone"/>
                        </div>
                        ...
                        <div class="contact_form_row">  <label id="contact_textmsg" for="contact_text">
                            ...
                            <textarea cols="50" rows="6" name="text" id="contact_text" class="inputbox required font-CenturyGothic" placeholder="Enter Your Message"></textarea>
                        </div>
