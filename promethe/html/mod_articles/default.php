...
<div class="module_articles">
    <div class="modarticle-items owl-carousel owl-theme owl-default">
<?php $c = 1;
   ...
   /* if($article->sectionid){
    ...
    if ((bool) $params->get('show_image')) {
        ...
        if(($date && $params->get('show_date')) or ($params->get('show_btn')) ){
         ...
         echo '</div></div>'; 
//        if($c%3 == 0 && $c < count($modarticles)){
//            echo '<div class="cls"></div>';
////            here was <div class="modarticle-items"></div> after cls
//        }
        $c++;
    }
    ?>
